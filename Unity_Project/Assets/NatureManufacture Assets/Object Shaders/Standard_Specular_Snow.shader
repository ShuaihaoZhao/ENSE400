Shader "NatureManufacture Shaders/Standard Shaders/Standard Specular Snow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 normalizeResult201 = normalize( BlendNormals( UnpackScaleNormal( tex2D( _BumpMap, uv_MainTex ), _SnowNormalCoverHardness ) , temp_output_237_0 ) );
			...
			float clampResult236 = clamp( ( tex2D( _SnowMaskB, uv_SnowMaskB ).b * _SnowMaskPower ) , 0.0 , 1.0 );
