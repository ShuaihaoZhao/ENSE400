...
namespace Gaia
{
    ...
    public class GaiaPipelineUtilsEditor : EditorWindow
    {
        ...
        /// </summary>
        public static void ShowGaiaPipelineUtilsEditor(GaiaConstants.EnvironmentRenderer oldRenderer, GaiaConstants.EnvironmentRenderer newRenderer, bool updateMaterials, GaiaManagerEditor gaiaManagerEditor)
        {
        ...
        private void FinalizeEnvironment()
        {
            switch (m_pipelineToInstall)
            {
                case GaiaConstants.EnvironmentRenderer.BuiltIn:
                    ...
                    GaiaPipelineUtils.SetupPipeline(m_pipelineToInstall, null, null, null, "Procedural Worlds/Simple Water");

                    break;
                case GaiaConstants.EnvironmentRenderer.LightWeight2018x:
                    SetPostProcessingStyle("Ambient Sample Default Day Post Processing");
                    GaiaPipelineUtils.SetupPipeline(m_pipelineToInstall, "Procedural Worlds Lightweight Pipeline Profile", "Pipeline Terrain Material", "Lightweight Render Pipeline/Terrain/Lit", "Procedural Worlds/Simple Water LW");
                    break;
                case GaiaConstants.EnvironmentRenderer.HighDefinition2018x:
                    SetPostProcessingStyle("Ambient Sample Default Day Post Processing");
                    GaiaPipelineUtils.SetupPipeline(m_pipelineToInstall, "Procedural Worlds HDRenderPipelineAsset", "Pipeline Terrain Material", "HDRP/TerrainLit", "Procedural Worlds/Simple Water HD");
                    break;
            }
