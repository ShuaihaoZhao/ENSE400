Shader "NatureManufacture Shaders/Road/Standard_Metallic_Road_Transparent"
{
	...
	SubShader
	{
		...
		uniform half _SecondRoadParallaxPower;
		uniform half _Float2;
		uniform half _MainRoadBrightness;
		uniform half4 _MainRoadColor;
		uniform half _SecondRoadBrightness;
		uniform half4 _SecondRoadColor;
		uniform half _Float1;
		uniform half _MainRoadMetalicPower;
		uniform half _SecondRoadMetalicPower;
		uniform half _MainRoadSmoothnessPower;
		uniform half _SecondRoadSmoothnessPower;
		uniform half _MainRoadAmbientOcclusionPower;
		uniform half _SecondRoadAmbientOcclusionPower;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_DetailMapAlbedoRNyGNxA = i.uv_texcoord * _DetailMapAlbedoRNyGNxA_ST.xy + _DetailMapAlbedoRNyGNxA_ST.zw;
			half4 tex2DNode486 = tex2D( _DetailMapAlbedoRNyGNxA, uv_DetailMapAlbedoRNyGNxA );
			...
			float2 Offset813 = ( ( tex2D( _TextureSample3, uv_TextureSample3 ).b - 1 ) * i.viewDir.xy * _SecondRoadParallaxPower ) + uv_TextureSample1;
			...
			half3 tex2DNode801 = UnpackScaleNormal( tex2D( _TextureSample2, Offset847 ), _Float0 );
			...
			half4 tex2DNode800 = tex2D( _TextureSample1, Offset847 );
			float4 temp_output_851_0 = ( ( _SecondRoadBrightness * tex2DNode800 ) * _SecondRoadColor );
			half4 temp_cast_1 = (( tex2DNode486.r * _DetailAlbedoPower )).xxxx;
			half4 blendOpSrc854 = temp_output_851_0;
			half4 blendOpDest854 = temp_cast_1;
			...
			half4 tex2DNode802 = tex2D( _TextureSample3, Offset847 );
