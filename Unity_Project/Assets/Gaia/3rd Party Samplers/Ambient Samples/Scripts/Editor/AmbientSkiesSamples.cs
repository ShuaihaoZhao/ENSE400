...
namespace Gaia.GX.ProceduralWorlds
{
    public class AmbientSkiesSamples : MonoBehaviour
    {
        ...
        public static void GX_Skies_Morning()
        {
            ...
            {
                GaiaPipelineUtils.SetupHDEnvironmentalVolume(true, false, true, false, false, false, false, m_gaiaSettings.m_currentRenderer, "High Definition Wind", "High Definition Environment Volume", 1f, 1f, "Density Volume", "FFFFFF", 150f, new Vector3(0.35f, 0f, 0f), "HD Volume Profile", "AmbientSkiesSampleMorningAndEvening", "FFC39E", 30f, 0.9f, 1050f, 5f);
            }
            else
            {
        ...
        public static void GX_Skies_Evening()
        {
            ...
            if (m_gaiaSettings.m_currentRenderer == GaiaConstants.EnvironmentRenderer.HighDefinition2018x)
            {
                GaiaPipelineUtils.SetupHDEnvironmentalVolume(true, false, false, false, true, false, false, m_gaiaSettings.m_currentRenderer, "High Definition Wind", "High Definition Environment Volume", 0.9f, 0.75f, "Density Volume", "FFFFFF", 200f, new Vector3(0.35f, 0f, 0f), "HD Volume Profile", "AmbientSkiesSampleMorningAndEvening", "FFD0C2", 150f, 0.81f, 1200f, 5f);
            }
            else
            {
#if UNITY_2018_1_OR_NEWER
        ...
        public static void GX_Skies_Night()
        {
            ...
            if (m_gaiaSettings.m_currentRenderer == GaiaConstants.EnvironmentRenderer.HighDefinition2018x)
            {
                GaiaPipelineUtils.SetupHDEnvironmentalVolume(true, false, false, false, false, true, false, m_gaiaSettings.m_currentRenderer, "High Definition Wind", "High Definition Environment Volume", 1f, 0.5f, "Density Volume", "4B4B4B", 300f, new Vector3(0.15f, 0f, 0f), "HD Volume Profile", "AmbientSkiesSampleNight", "9EC0FF", 135f, 0.57f, 800f, 50f);
            }
            else
            {
#if UNITY_2018_1_OR_NEWER
        ...
        public static void GX_Skies_DefaultProcedural()
        {
            ...
            if (m_gaiaSettings.m_currentRenderer == GaiaConstants.EnvironmentRenderer.HighDefinition2018x)
            {
                GaiaPipelineUtils.SetupHDEnvironmentalVolume(true, false, false, true, false, false, true, m_gaiaSettings.m_currentRenderer, "High Definition Wind", "High Definition Environment Volume", 1.5f, 2.5f, "Density Volume", "FFFFFF", 300f, new Vector3(0.15f, 0f, 0f), "HD Volume Profile", "AmbientSkiesSampleDay", "FFF6E9FF", 110f, 1.95f, 1200f, -25f);
            }
            else
            {
