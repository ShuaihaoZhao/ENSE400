Shader "NatureManufacture Shaders/Standard Shaders/Standard Specular Snow CutOut"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float4 tex2DNode205 = tex2D( _DetailMapAlbedoRNyGNxA, uv_DetailMapAlbedoRNyGNxA );
			...
			float3 normalizeResult201 = normalize( BlendNormals( UnpackScaleNormal( tex2D( _BumpMap, uv_MainTex ), _SnowNormalCoverHardness ) , temp_output_226_0 ) );
			...
			float clampResult225 = clamp( ( tex2D( _SnowMaskB, uv_SnowMaskB ).b * _SnowMaskPower ) , 0.0 , 1.0 );
