...
namespace Gaia
{
    ...
    public class GaiaManagerEditor : EditorWindow, IPWEditor
    {
        ...
        void OnEnable()
        {
            ...
            {
                GaiaPipelineUtilsEditor.ShowGaiaPipelineUtilsEditor(m_gaiaSettings.m_currentRenderer, m_gaiaSettings.m_currentRenderer, false, this);               
                ...
                else
                {
                                ...
                                "Yes", "No"))
                    {
                        ...
                        */
                        ...
                        GaiaPipelineUtilsEditor.ShowGaiaPipelineUtilsEditor(m_settings.m_currentRenderer, targetRenderer, upgradeMaterials, this);
